...
if TYPE_CHECKING:
    from ..models.source_create_health_type_0 import SourceCreateHealthType0
    from ..models.source_create_schedule_type_0 import SourceCreateScheduleType0
...
class SourceCreate:
    ...
    Attributes:
        ...
        schedule (None | SourceCreateScheduleType0 | Unset):
        beat (None | str | Unset):
        geo (None | str | Unset):
        related_sources (list[str] | None | Unset):
        registered_at (datetime.datetime | None | Unset):
        health (None | SourceCreateHealthType0 | Unset):
    ...
    schedule: None | SourceCreateScheduleType0 | Unset = UNSET
    ...
    health: None | SourceCreateHealthType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.schedule, Unset):
            schedule = UNSET
        elif isinstance(self.schedule, SourceCreateScheduleType0):
        ...
        if isinstance(self.health, Unset):
            health = UNSET
        elif isinstance(self.health, SourceCreateHealthType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_schedule(data: object) -> None | SourceCreateScheduleType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                schedule_type_0 = SourceCreateScheduleType0.from_dict(data)

                return schedule_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SourceCreateScheduleType0 | Unset, data)
        ...
        def _parse_health(data: object) -> None | SourceCreateHealthType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                health_type_0 = SourceCreateHealthType0.from_dict(data)

                return health_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SourceCreateHealthType0 | Unset, data)
