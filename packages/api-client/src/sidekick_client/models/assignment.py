...
if TYPE_CHECKING:
    from ..models.assignment_monitor_type_0 import AssignmentMonitorType0
    from ..models.assignment_query_params_type_0 import AssignmentQueryParamsType0
...
class Assignment:
    ...
    Attributes:
        ...
        query_params (AssignmentQueryParamsType0 | None | Unset):
        ...
        monitor (AssignmentMonitorType0 | None | Unset):
    """
    ...
    query_params: AssignmentQueryParamsType0 | None | Unset = UNSET
    ...
    monitor: AssignmentMonitorType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.query_params, Unset):
            query_params = UNSET
        elif isinstance(self.query_params, AssignmentQueryParamsType0):
        ...
        if isinstance(self.monitor, Unset):
            monitor = UNSET
        elif isinstance(self.monitor, AssignmentMonitorType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_query_params(data: object) -> AssignmentQueryParamsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                query_params_type_0 = AssignmentQueryParamsType0.from_dict(data)

                return query_params_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AssignmentQueryParamsType0 | None | Unset, data)
        ...
        def _parse_monitor(data: object) -> AssignmentMonitorType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                monitor_type_0 = AssignmentMonitorType0.from_dict(data)

                return monitor_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AssignmentMonitorType0 | None | Unset, data)
